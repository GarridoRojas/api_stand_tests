...
def test_create_user_2_letter_in_first_name_get_success_response():
    print("Probando insercion de usuario 2 caracteres...")
    positive_assert("Aa")

def test_create_user_15_letter_in_first_name_get_success_response():
    print(f"probando insercion 15 caracteres...")
...
def negative_assert_no_firstname(user_body):
    print(f"\u001B[94mEjecutando la funcion negative_assert_no_firstname...\u001B[0m")
    print(f"user_body: {user_body}")
    ...
    print(response.json())
    print(f"si estas viendo este mensaje las 3 condiciones pasaron")


def test_create_user_no_first_name_get_error_response():
    print(f"\u001B[32mEjecutando la funcion test_create_user_no_first_name_get_error_response...\u001B[0m")
